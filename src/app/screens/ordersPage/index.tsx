...
import { AspectRatio, Avatar, ButtonGroup, CardOverflow, Chip, CssVarsProvider, IconButton, SvgIcon } from "@mui/joy";
                    ...
                    <CssVarsProvider>
                        <Card className={"card-user"} >
                            ...
                            <CardOverflow sx={{ bgcolor: 'background.surface' }}>
                                ...
                                <ButtonGroup variant="soft" sx={{ bgcolor: 'background.surface' }}>
                            ...
                            <CardOverflow>
                                <Divider width={"100px"} height={"1px"} bg="#d7b686" />
